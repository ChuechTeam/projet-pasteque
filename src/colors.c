...
void initColors() {
    ...
    initBGColorWhite(PASTEQUE_COLOR_BRONZE_BG, 94);

    initBGColorBlack(PASTEQUE_COLOR_SILVER_BG, 249);

    initBGColorBlack(PASTEQUE_COLOR_GOLD_BG, 220);

    initBGColorWhite(PASTEQUE_COLOR_DARK_PURPLE_BG, 53);
